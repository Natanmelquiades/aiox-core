---
name: aiox-workflow-auto-worktree
description: "Use the AIOX workflow auto-worktree.yaml in Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX workflow: auto-worktree.yaml
  ...
  pre_flight:
    ...
    checks:
      ...
      - id: worktree_manager
        ...
        file_exists: .aiox-core/infrastructure/scripts/worktree-manager.js
        blocking: true
        error: "WorktreeManager not found. AIOX infrastructure incomplete."
  ...
  sequence:
    ...
    - step: switch_worktree
      ...
      script: |
        ...
        process.env.AIOX_WORKTREE = worktreePath;
        process.env.AIOX_STORY = storyId;
