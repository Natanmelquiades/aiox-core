---
name: aiox-task-generate-ai-frontend-prompt
description: "Use the AIOX task generate-ai-frontend-prompt.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: generate-ai-frontend-prompt.md
