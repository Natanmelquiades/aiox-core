---
name: aiox-task-facilitate-brainstorming-session
description: "Use the AIOX task facilitate-brainstorming-session.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: facilitate-brainstorming-session.md
