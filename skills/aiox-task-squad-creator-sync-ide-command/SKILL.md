---
name: aiox-task-squad-creator-sync-ide-command
description: "Use the AIOX task squad-creator-sync-ide-command.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: squad-creator-sync-ide-command.md
