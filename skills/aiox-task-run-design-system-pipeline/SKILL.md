---
name: aiox-task-run-design-system-pipeline
description: "Use the AIOX task run-design-system-pipeline.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: run-design-system-pipeline.md
