---
name: aiox-task-export-design-tokens-dtcg
description: "Use the AIOX task export-design-tokens-dtcg.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: export-design-tokens-dtcg.md
