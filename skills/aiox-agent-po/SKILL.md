---
name: aiox-agent-po
description: "Use the AIOX po role in Hermes for Use for backlog management, story refinement, acceptance criteria, sprint planning, and prioritization decisions."
version: 5.4.1
author: SynkraAI
license: MIT
...
Load this role when the user explicitly asks for the AIOX `po` function or
...
- **ID:** `po`
- **Title:** Product Owner
- **Original file:** `.aiox-core/development/agents/po.md`
