---
name: aiox-task-create-deep-research-prompt
description: "Use the AIOX task create-deep-research-prompt.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: create-deep-research-prompt.md
