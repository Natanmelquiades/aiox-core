---
name: aiox-task-delegate-to-external-executor
description: "Use the AIOX task delegate-to-external-executor.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: delegate-to-external-executor.md
