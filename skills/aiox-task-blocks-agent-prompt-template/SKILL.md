---
name: aiox-task-blocks-agent-prompt-template
description: "Use the AIOX task blocks/agent-prompt-template.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: blocks/agent-prompt-template.md
