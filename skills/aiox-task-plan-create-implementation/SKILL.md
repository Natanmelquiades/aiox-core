---
name: aiox-task-plan-create-implementation
description: "Use the AIOX task plan-create-implementation.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: plan-create-implementation.md
