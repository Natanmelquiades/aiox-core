---
name: aiox-task-generate-migration-strategy
description: "Use the AIOX task generate-migration-strategy.md inside Hermes."
version: 5.4.1
author: SynkraAI
license: MIT
...
# AIOX task: generate-migration-strategy.md
